...
// Lista de usuarios permitidos (puedes agregar más usuarios aquí)
const allowedUsers = ['pass123', 'User3']; // Agrega los nombres de los usuarios que quieras permitir
...
app.post('/upload', upload.single('song'), (req, res) => {
    ...
    const username = req.body.username; // Obtener el nombre del usuario
